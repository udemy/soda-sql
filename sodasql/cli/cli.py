...
@click.option('-a', '--analyze_templates', required=False, default=None, help='Allows to customize the sql select statements used for column analyze. Default is select column from table limit 1000 or equivalent')
